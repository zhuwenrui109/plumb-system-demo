          ...
          <div class="td-item">
			...
			<div class="tr">
				...
				<div class="td stand">
					...
					<div class="td-list" v-show="true">
						<div class="td-item">
							<div class="num english">1</div>
							<div class="txt english">过滤区</div>
							<div class="btn-list">
				...
				<div class="td handle">
					<div class="td-item">
						...
						/>
            <div class="add-btn">
              <img src="../assets/images/icon-setting-add.png" alt="" class="add-icon">
              <span>添加工艺区</span>
            </div>
					</div>
				</div>
